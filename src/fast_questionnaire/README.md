# Package conventions in `fast_questionnaire`
...
```python
from fast_questionnaire.billing import total_due              # fine: the package's public surface
from fast_questionnaire.billing.quote import estimate         # fine: a further public entry point
from fast_questionnaire.billing._internal._totals import total_due   # fails `tach check`
```
...
the shape applies to every package under `src/fast_questionnaire/`, whichever they are.
